...
const CARDS = [
  ...
  },
  {
    ...
    desc:  'Common errors, portal timeout recovery, handling absent or detained students, and re-running partial jobs without duplication.',
    cta:   'See solutions',
  },
  {
    id:    'privacy',
...
export default function ResourcesSection() {
  return (
    <section
      id="resources"
      className="py-32 px-6 bg-slate-50/70"
      aria-label="Resources"
    >
      <div className="max-w-7xl mx-auto">

        {/* Header — sits completely above the grid */}
        <motion.div
          variants={rise}
          initial="hidden"
          whileInView="show"
        ...
        >
          ...
          <p className="text-slate-600 leading-relaxed text-lg mt-4 max-w-xl mx-auto">
            Everything you need to install, run, and troubleshoot from day one.
          </p>
        </motion.div>

        {/* Cards — mt-12 separates them clearly from the header */}
